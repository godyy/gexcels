...
var (
	...
	// errRuleUniqueOnNonPrimitiveField unique规则应用在非primitive字段上
	errRuleUniqueOnNonPrimitiveField = errors.New("field rule unique on non-primitive field")

	// errRuleLinkOnNonPrimitiveField link规则应用在非primitive字段上
	errRuleLinkOnNonPrimitiveField = errors.New("field rule link on non-primitive field")

	// errRuleCompositeKeyOnNonPrimitiveField 组合键规则应用在非primitive字段上
	errRuleCompositeKeyOnNonPrimitiveField = errors.New("field rule composite-key on non-primitive field")

	// errRuleCompositeKeyOnGlobalTable 组合键应用在全局配置表上
	errRuleCompositeKeyOnGlobalTable = errors.New("field rule composite-key on global table")
